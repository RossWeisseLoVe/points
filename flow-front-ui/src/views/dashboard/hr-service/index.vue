<template>
  <PageWrapper class="w-full" >
    <div class="flex enter-y">
      <div class="w-1/4 mr-4">
        <UserInfo class="!mb-4 enter-y" />
      </div>
      <div class="w-1/2">
        <BannerInfo :dataSource="bannerInfoItems" height="264" class="!mb-4 enter-y" :loading="loading"></BannerInfo>
      </div>
      <div class="w-1/4 pl-4">
        <NoticeInfo :dataSource="noticeInfoItems" :loading="loading" class="!mb-4 enter-y" />
      </div>
    </div>
